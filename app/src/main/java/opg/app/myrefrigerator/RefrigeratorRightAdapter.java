...
// Apdater
public class RefrigeratorRightAdapter extends RecyclerView.Adapter<RefrigeratorRightAdapter.CustomViewHolder> {
    ...
    public RefrigeratorRightAdapter(ArrayList<RefrigeratorRightData> arrayList) {
        this.arrayList = arrayList;
    }

    @NonNull
    @Override
    public RefrigeratorRightAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.refrigerator_left_item_list,parent,false);
        RefrigeratorRightAdapter.CustomViewHolder holder = new RefrigeratorRightAdapter.CustomViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RefrigeratorRightAdapter.CustomViewHolder holder, int position) {
        //황호준 - 데이터베이스 삭제 연관 변수
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                sqlDB.execSQL("DELETE FROM ItemDataRight WHERE itemName='" + name+"' AND itemdate ='"+ date +"';");
                sqlDB.close();
